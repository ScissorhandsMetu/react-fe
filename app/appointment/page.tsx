...
const AppointmentContent = () => {
  ...
  if (!time || !barberName) {
    return (
      <div className="container p-4 text-center bg-secondary/20">
    ...
    <div className="container mx-auto max-w-xl rounded-lg bg-secondary/20 p-6 shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="mt-4 w-full rounded-lg bg-primary py-3 text-lg font-semibold text-white transition-all hover:bg-primary-dark disabled:bg-gray-400"
            disabled={loading}
          >
