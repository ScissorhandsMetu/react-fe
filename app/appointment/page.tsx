...
const AppointmentContent = () => {
    ...
    return (
      <div className="container p-4 text-center">
        ...
        <button
          type="button"
          onClick={() => router.push("/")}
          className="mt-4 rounded-full bg-blue-500 px-6 py-2 text-white transition-all hover:bg-blue-600"
        >
          Back to Home
        </button>
      </div>
  ...
  return (
    <div className="container mx-auto max-w-xl rounded-lg bg-white p-6 shadow-lg">
      ...
      <div className="mb-4">
        <h2 className="text-center text-2xl text-gray-800">
          Selected Barber: <span className="text-blue-500">{barberName}</span>
        </h2>
        <h3 className="text-center text-xl text-gray-600">
          Selected Time: <span className="text-blue-500">{time}</span>
        </h3>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="mt-4 w-full rounded-lg bg-blue-600 py-3 text-lg font-semibold text-white transition-all hover:bg-blue-700 disabled:bg-gray-400"
            disabled={loading}
          >
